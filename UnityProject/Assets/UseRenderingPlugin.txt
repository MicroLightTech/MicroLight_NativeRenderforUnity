...
public class UseRenderingPlugin : MonoBehaviour
{
    ...
    [DllImport("RenderingPlugin")]
#endif
    private static extern void SetRenderTexture(IntPtr colorBuffer, IntPtr depthBuffer, int textureWidth, int textureHeight);
    ...
    IEnumerator Start()
	{
        ...
        if(RenderCamera)
        {
            ...
            Debug.Log(" NativeTexturePtr:" + target.GetNativeTexturePtr());
            SetRenderTexture(target.GetNativeTexturePtr(), target.GetNativeTexturePtr(), 1920, 1080);
        }
