...
static void UNITY_INTERFACE_API OnRenderEvent(int eventID)
{
	...
	s_CurrentAPI->RenderDistrutionPass();
}
...
extern "C" void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API SetRenderTexture(void* colorBuffer, void* depthBuffer, int textureWidth, int textureHeight)
{
	// Unknown / unsupported graphics device type? Do nothing
	if (s_CurrentAPI == NULL)
		return;

	s_CurrentAPI->SetRenderTexture(colorBuffer, depthBuffer, textureWidth, textureHeight);
}
